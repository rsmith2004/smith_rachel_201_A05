...
```{r}
#vector with each player's heights
heights <- c(MJ = 78, LJ = 81, KB = 78, KA = 86, SO = 85) 

#loop adding heights to respective player 
...
#function calculating the points per game
for (player in names(player_info)){
  #getting the points of that player
  x_points <- player_info[[player]]$points 
  
  #getting the games played of that player
  x_games_played <- player_info[[player]]$games_played 
  
  #calculating the points per game of that player and adding to list
...
```{r}
#rounding the points per game and creating a new vector
